...
public class ChangepasswordController {
    ...
    public Map<String, Object> changepassword(@RequestBody Changepassword changepassword1) {
        Map<String, Object> response = new HashMap<>();
        String changephone = changepassword1.getChangephone();
        String newpassword = changepassword1.getNewpassword();
        // 检查手机号是否为11位
